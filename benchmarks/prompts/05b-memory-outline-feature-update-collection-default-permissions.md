...
Case id: `outline_feature_update_collection_default_permissions`
Variant: `memory`
Complexity: `complex`
...
$workspace = "D:\git\ai\outline-benchmarks\outline_feature_update_collection_default_permissions\memory"
$branch = "benchmark/outline_feature_update_collection_default_permissions-memory"
...
Task: Implement inherited default permission settings for newly created Outline
collections.

This is a complex feature update. Expect multi-boundary work across API request
validation, authorization policies, persistence, presenters or response shape,
and focused tests.
...
project="outline"
component="api"
request="Implement inherited default permission settings for newly created Outline collections."
include_global=true
...
```text
BENCHMARK_RESULT
case_id: outline_feature_update_collection_default_permissions
project: outline
variant: memory
worktree:
branch:
