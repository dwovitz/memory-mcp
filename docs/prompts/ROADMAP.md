...
| 1 | Auto-capture + distillation | [impl-auto-capture.md](impl-auto-capture.md) | `feat/auto-capture-distillation` | Sonnet | 1–2 days | ✅ pending Track 1R verification |
...
| 7 | P2 event-flow memory types | [impl-p2-event-flow.md](impl-p2-event-flow.md) | `feat/p2-event-flow` | Sonnet | 3–5 hrs | ⬜ blocked by Track 1R |
| 8 | P2 context packet diagnostics | [impl-p2-packet-diagnostics.md](impl-p2-packet-diagnostics.md) | `feat/p2-packet-diagnostics` | Sonnet | 3–4 hrs | ⬜ blocked by Track 1R |
| 9 | P2 code graph import tool | [impl-p2-code-graph-import.md](impl-p2-code-graph-import.md) | `feat/p2-code-graph-import` | Sonnet | 3–4 hrs | ⬜ blocked by Track 1R |
| 10 | P2 multi-repo benchmark harness | [impl-p2-benchmarks.md](impl-p2-benchmarks.md) | `feat/p2-benchmarks` | Sonnet | 1 day | ⬜ blocked by Track 1R |
| 11 | P3 client hook pack | [impl-p3-hook-pack.md](impl-p3-hook-pack.md) | `feat/p3-hook-pack` | Haiku | 2–4 hrs | ⬜ blocked by Track 1R |
| 12 | P3 hosted mode hardening | [impl-p3-hosted-mode.md](impl-p3-hosted-mode.md) | `feat/p3-hosted-mode` | Sonnet | 4–8 hrs | ⬜ blocked by Track 1R |

## Sequencing Constraints

- Track 1R must be completed before Track 7 or later.
- Track 1 is considered complete only after Track 1R verifies that the implemented repo state matches the accepted auto-capture/distillation design, or corrects the roadmap/prompt files to match a superseded design.
...
- Track 10 (benchmarks) should run after Tracks 2, 4, 5, 6 and Track 1R are merged.
